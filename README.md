...
1. Eseguire `sql/tris_create_tables.sql` su phpMyAdmin
2. Aprire il tunnel SSH: `ssh -N -L 3307:localhost:3306 [username]@lab.alberghetti.cloud`
3. Modificare user e password in `tris_db_config.py`
4. Installare pymysql: `pip install pymysql`
5. Eseguire: `python main.py`
